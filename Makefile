...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/test/util/bitcoin-util-test.py COPYING README.md \
...
ACLOCAL = ${SHELL} '/root/coin-dev/build-aux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} '/root/coin-dev/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/root/coin-dev/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/root/coin-dev/build-aux/missing' automake-1.16
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
CPPFLAGS = -I/usr/local/include -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS
CRYPTO_CFLAGS = 
CRYPTO_LIBS = -lcrypto
CSCOPE = cscope
CTAGS = ctags
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} '/root/coin-dev/build-aux/missing' makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_STRING = Bitcoin Core 0.15.2
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /root/coin-dev
abs_srcdir = /root/coin-dev
abs_top_builddir = /root/coin-dev
abs_top_srcdir = /root/coin-dev
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/coin-dev/build-aux/install-sh
