...
!define MUI_ICON "/root/coin-dev/share/pixmaps/bitcoin.ico"
!define MUI_WELCOMEFINISHPAGE_BITMAP "/root/coin-dev/share/pixmaps/nsis-wizard.bmp"
!define MUI_HEADERIMAGE
!define MUI_HEADERIMAGE_RIGHT
!define MUI_HEADERIMAGE_BITMAP "/root/coin-dev/share/pixmaps/nsis-header.bmp"
...
!define MUI_UNWELCOMEFINISHPAGE_BITMAP "/root/coin-dev/share/pixmaps/nsis-wizard.bmp"
...
OutFile /root/coin-dev/bitcoin-${VERSION}-win-setup.exe
!if "" == "64"
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File /root/coin-dev/release/bitcoin-qt
    File /oname=COPYING.txt /root/coin-dev/COPYING
    File /oname=readme.txt /root/coin-dev/doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File /root/coin-dev/release/bitcoind
    File /root/coin-dev/release/bitcoin-cli
    SetOutPath $INSTDIR\doc
    File /r /root/coin-dev/doc\*.*
    SetOutPath $INSTDIR
